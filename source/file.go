...
func FielYieldLine(out chan<- string, parser *configparser.ConfigParser) {
	...
	lines, err := tail.TailFile(fileName, tail.Config{Follow: true, Location: &tail.SeekInfo{Offset: 0, Whence: startPosition}})
	if err != nil {
